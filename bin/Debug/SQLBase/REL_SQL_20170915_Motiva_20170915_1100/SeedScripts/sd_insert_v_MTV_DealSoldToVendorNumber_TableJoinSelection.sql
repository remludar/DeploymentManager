...
SET		@CreateTable		= 'v_MTV_DealSoldToVendorNumber'
SET		@CreateTableAbbv	= 'MDSV'
SET		@CreateTableDesc	= 'Deal SoldTo_VendorNumber'

--JOIN TABLE INFORMATION
SET		@JoinTable			= 'DealHeader'
SET		@JoinType			= 'ManyToOne'	-- 'ManyToOne'
SET		@LeftOuterJoin		= 'Y'
SET		@RelationshipPrefix	= NULL
SET		@JoinSyntax			= '[v_MTV_DealSoldToVendorNumber].DlHdrID = [DealHeader].DlHdrID'
SET		@Bidirectional		= 'Y'
