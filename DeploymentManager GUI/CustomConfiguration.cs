...
namespace DeploymentManager_GUI
{
    public class ConnectionManagerDataSection : ConfigurationSection
    {
        ...
        public ConnectionManagerEnvironmentsCollection ConnectionManagerEnvironments { get { return (ConnectionManagerEnvironmentsCollection)base[EnvironmentCollectionName]; } }
    }
